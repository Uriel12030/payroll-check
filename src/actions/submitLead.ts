...
export async function submitLead(
  ...
  if (existingLeadId) {
    // Update existing quick-start lead with full data
    ...
    if (updateError) {
      console.error('Lead update error:', updateError.code, updateError.message, updateError.details)
